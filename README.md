...
<p align="center">
Atividades referente à Unidade II de Algoritmos e Estrutura de Dados.
</p>
...
<p align="center">
  <img alt="Preview do projeto desenvolvido." src="https://i.imgur.com/jDUj93o.png" width="80%">
</p>

> Atividade realizada no dia 22 de Agosto de 2025
...
- Exercício 4: Verificação de Expressões
...
- Exercício 10: Desafio Final - Implementação de Algoritmo de Ordenação

## 💻 Objetivo

Colocar em prática tudo o que aprendi no decorrer das aulas da Unidade II de Algoritmos e Estrutura de Dados.
